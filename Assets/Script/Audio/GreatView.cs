...
public class GreatView : MonoBehaviour
{
    ...
    /*
    private GreatA greatA;
    private GreatS greatS;
    private GreatD greatD;
    private GreatF greatF;
    private GreatG greatG;
    private GreatH greatH;
    private GreatJ greatJ;
    private GreatK greatK;
    */
    ...
    void Start()
    {
        ...
        /*
        greatA = obj1.GetComponent<GreatA>();
        greatS = obj2.GetComponent<GreatS>();
        greatD = obj3.GetComponent<GreatD>();
        greatF = obj4.GetComponent<GreatF>();
        greatG = obj5.GetComponent<GreatG>();
        greatH = obj6.GetComponent<GreatH>();
        greatJ = obj7.GetComponent<GreatJ>();
        greatK = obj8.GetComponent<GreatK>();*/
    }
